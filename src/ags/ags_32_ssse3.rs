...
pub(crate) unsafe fn _binary_to_ascii_32_ssse3_c16_chunks16(
    ...
    //
    {
        ...
        //
        {
            ...
            let mm_check2 = _mm_cmpgt_epi8(mm_in, _mm_set1_epi8(32 - 1));
...
#[inline(never)]
#[target_feature(enable = "ssse3")]
pub(crate) unsafe fn _ascii_to_binary_32_ssse3(
    lup: &[u8],
    buf: &mut [u8],
) -> Result<(), DecodeError> {
    assert_eq!(lup.len(), 128);
    _ascii_to_binary_32_ssse3_chunks16(lup, buf)?;
    Ok(())
}
...
#[inline(always)]
//#[target_feature(enable = "ssse3")]
pub(crate) unsafe fn _ascii_to_binary_32_ssse3_c16(
    lup: &[u8],
    buf: &mut [u64; 2],
) -> Result<(), DecodeError> {
    assert_eq!(lup.len(), 128);
    _ascii_to_binary_32_ssse3_c16_chunks16(lup, buf)?;
    Ok(())
}
...
#[inline(always)]
pub(crate) unsafe fn _ascii_to_binary_32_ssse3_c16_chunks16(
    lup: &[u8],
    buf: &mut [u64; 2],
) -> Result<(), DecodeError> {
    //panic!("PASS: SSE2");
...
#[inline(always)]
pub(crate) unsafe fn _ascii_to_binary_32_ssse3_chunks16(
    lup: &[u8],
    buf: &mut [u8],
) -> Result<(), DecodeError> {
    //panic!("PASS: SSE2");
